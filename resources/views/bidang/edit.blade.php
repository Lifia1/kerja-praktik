                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('bidang.update', $bidang->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama_bidang" class="block mt-1 w-full" type="text" name="nama_bidang" :value="old('nama_bidang', $bidang->nama_bidang)" required autofocus />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="kode_bidang" class="block mt-1 w-full" type="text" name="kode_bidang" :value="old('kode_bidang', $bidang->kode_bidang)" required />
